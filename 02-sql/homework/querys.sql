...
WHERE m.name = 'Braveheart' and WHERE m.year = 1995
...
JOIN movies as m on m.id = r.actor_id
...
-- 11 .Buscá actores que actuaron en cinco o más roles en la misma película después
--  del año 1990. Noten que los ROLES pueden tener duplicados ocasionales,
--   sobre los cuales no estamos interesados: queremos actores que
--    hayan tenido cinco o más roles DISTINTOS (DISTINCT cough cough)
--     en la misma película. Escribí un query que retorne los nombres del actor,
...
-- 12 . Para cada año, contá el número de películas en ese años que sólo tuvieron 
-- actrices femeninas.
